...
type ChanlunSignal struct {
	...
	StructureToTriggerLatencyCandles int               `json:"structure_to_trigger_latency_candles,omitempty"`
	...
	ThirdPointQualityCategory        string            `json:"third_point_quality_category,omitempty"`
	SupportGapPct                    float64           `json:"support_gap_pct,omitempty"`
	SupportGapATR                    float64           `json:"support_gap_atr,omitempty"`
	RetracementRatio                 float64           `json:"retracement_ratio,omitempty"`
	PullbackCandles                  int               `json:"pullback_candles,omitempty"`
