...
export const translations = {
  en: {
    ...
    exchangeEquity: 'Exchange Equity',
    configuredInitialBalance: 'Configured Initial',
    strategyBaseline: 'Strategy Baseline',
    strategyAllocatedCapital: 'Allocated Capital',
    unreliableReturn: 'Return baseline unreliable',
  ...
  zh: {
    ...
    initialBalance: '初始余额',
    exchangeEquity: '交易所净值',
    configuredInitialBalance: '配置初始资金',
    strategyBaseline: '策略基准',
    strategyAllocatedCapital: '策略分配资金',
    unreliableReturn: '收益基准不可靠',
    currentEquity: '当前净值',
